...
namespace ManagedBass.Dynamics
{
    ...
    public static class BassMidi
    {
        ...
        [DllImport(DllName)]
        public static extern int BASS_MIDI_StreamCreateFile(bool mem, [MarshalAs(UnmanagedType.BStr)]string file, long offset, long length, BassFlags flags, int freq);
        ...
        [DllImport(DllName)]
        static extern int BASS_MIDI_FontInit([MarshalAs(UnmanagedType.BStr)] string File, BassFlags flags);
        ...
        [DllImport(DllName)]
        static extern bool BASS_MIDI_FontPack(int handle, [MarshalAs(UnmanagedType.BStr)] string outfile, [MarshalAs(UnmanagedType.BStr)] string encoder, BassFlags flags);
        ...
        [DllImport(DllName)]
        static extern bool BASS_MIDI_FontUnpack(int handle, [MarshalAs(UnmanagedType.BStr)] string outfile, BassFlags flags);
