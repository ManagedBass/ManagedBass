...
namespace ManagedBass
{
    public static partial class Bass
    {
        ...
        /// This option can only be set before <see cref="GetDeviceInfo(int,out DeviceInfo,bool)"/> or <see cref="Init"/> has been called.
        /// <para>
        ...
        /// The default setting is ANSI, and it can only be changed before <see cref="GetDeviceInfo(int,out DeviceInfo,bool)"/> or <see cref="Init"/>
